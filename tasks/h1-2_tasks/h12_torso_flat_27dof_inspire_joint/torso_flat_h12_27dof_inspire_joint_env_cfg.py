...
@configclass
class TorsoFlatSceneCfg(InteractiveSceneCfg):
    """Minimal H1-2 debugging scene: ground, light, robot, and cameras."""
...
@configclass
class TorsoFlatH12InspireJointEnvCfg(ManagerBasedRLEnvCfg):
    scene: TorsoFlatSceneCfg = TorsoFlatSceneCfg(
        num_envs=1,
        env_spacing=2.5,
