...
_H12_WHOLEBODY_DEFAULT_JOINT_POS = H12_CFG_WITH_INSPIRE_HAND.init_state.joint_pos.copy()
_H12_WHOLEBODY_DEFAULT_JOINT_POS.update(
    {
...
H12_CFG_WITH_INSPIRE_WHOLEBODY = H12_CFG_WITH_INSPIRE_HAND.replace(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.80),
        joint_pos=_H12_WHOLEBODY_DEFAULT_JOINT_POS,
        joint_vel={".*": 0.0},
    ),
    soft_joint_pos_limit_factor=0.90,
    actuators={
        ...
        "hands": H12_CFG_WITH_INSPIRE_HAND.actuators["hands"],
    },
)
