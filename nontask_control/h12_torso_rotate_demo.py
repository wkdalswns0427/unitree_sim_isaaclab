...
"""Publish a standing H1-2 torso oscillation over DDS low-level commands."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="H1-2 torso rotation DDS demo")
    ...
    parser.add_argument("--amp", type=float, default=0.35, help="Torso amplitude (rad)")
...
def main() -> None:
    ...
    print("Publishing H1-2 torso oscillation on rt/lowcmd. Press Ctrl+C to stop.")
